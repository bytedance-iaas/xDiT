...
#TASK_ARGS="--height 720 --width 1280 --num_frames 81 --seed 0 --enable_fa3"
TASK_ARGS="--height 720 --width 1280 --num_frames 81 --seed 0"
#seed=$RANDOM
#TASK_ARGS="--height 720 --width 1280 --num_frames 81 --seed $seed"
