...
class ImageGenerator:
    ...
    def initialize_model(self, xfuser_args: xFuserArgs):
        ...
        pipeline_map = {
            ...
            "FLUX.1-Kontext-dev": xFuserFluxKontextPipeline,
        }
        ...
        elif PipelineClass is xFuserFluxKontextPipeline:
            cache_args = {
                "use_teacache": xfuser_args.use_teacache,
                "use_fbcache": xfuser_args.use_fbcache,
                "rel_l1_thresh": xfuser_args.cache_threshold,
    ...
    def generate(self, request: GenerateRequest):
        ...
        try:
            ...
            if xfuser_args.use_teacache is True or xfuser_args.use_fbcache is True and xfuser_args.use_svdq is False:
                self.pipe.transformer.clear_cache_modulated_inputs()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--svdq_quantized_model_path', '--svdq-quantized-model-path', type=str, default='',
                        help='Quantized path to SVDQuant FLUX model')
